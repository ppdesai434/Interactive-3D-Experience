...
public class Demo3 extends javax.swing.JFrame implements WiimoteListener{
	double theta;
	double theta1;
	double theta4;
 ...
 t3d.setScale(0.001); // for untitled(2).wrl 
