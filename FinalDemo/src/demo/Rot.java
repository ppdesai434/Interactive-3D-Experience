...
public class Rot extends javax.swing.JFrame implements WiimoteListener {
	private int rotnum;
...
System.out.println("Awt behavior flag");
        ...
        awtB = new RotateBehavior1(objTrans);
        
        
        BoundingSphere bounds1 = new BoundingSphere(new Point3d(0.0, 0.0, 0.0),
 			   100.0);
        awtB.setSchedulingBounds(bounds1);
        objRoot.addChild(awtB);
        
        rup = new Ro(objTrans);
        BoundingSphere b1 = new BoundingSphere(new Point3d(0.0, 0.0, 0.0),
  			   100.0);
         rup.setSchedulingBounds(b1);
         objRoot.addChild(rup);
    ...
    class RotateBehavior1 extends Behavior {
        ...
        RotateBehavior1(TransformGroup tg) {
            transformGroup = tg;
        }
