...
public class Retrieve extends JFrame {
	...
	public Retrieve() {
		...
		JLabel lblPartsretrieve = new JLabel("Parts-Retrieve");
		lblPartsretrieve.setFont(new Font("Comic Sans MS", Font.BOLD, 14));
		lblPartsretrieve.setBounds(171, 0, 110, 14);
		panel.add(lblPartsretrieve);
		...
		btnRetrieve.setBounds(112, 251, 169, 23);
