...
public class Update extends JFrame {
	...
	public Update() {
		...
		JLabel lblPartsupdate = new JLabel("Parts-Update");
		lblPartsupdate.setFont(new Font("Comic Sans MS", Font.BOLD, 14));
		lblPartsupdate.setBounds(171, 0, 110, 14);
		panel.add(lblPartsupdate);
		...
		btnUpdate.setBounds(112, 251, 169, 23);
		panel.add(btnUpdate);
		...
		lblWhere.setBounds(95, 39, 46, 14);
		panel.add(lblWhere);
	}
