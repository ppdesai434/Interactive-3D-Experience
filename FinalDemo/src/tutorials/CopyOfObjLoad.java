 ...
 */
public class CopyOfObjLoad extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	BranchGroup objRoot= new BranchGroup();
       ...
       // objScale.setTransform(t3d);
        t3d.rotX(Math.toRadians(-88.0)); //for carl house
       // t3d.rotY(Math.toRadians(-88.0));
       // t3d.rotX(Math.toRadians(-88.0));
       
      //  t3d.rotY(Math.toRadians(88.0));
       // t3d.rotZ(Math.toRadians(88.0));
	...
	try {
	 // s = f.load("src/app2obj.obj");
		s= loader.load("src/Iron man mark II_1.wrl");
     ...
     */
    public CopyOfObjLoad(String args[]) {
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  CopyOfObjLoad objLoad = new CopyOfObjLoad(args);
