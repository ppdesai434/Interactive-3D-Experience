...
public class fantas extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	try {
		...
		s= loader.load("src/ha/Ha-uschen.wrl ");
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  fantas objLoad = new fantas(args);
