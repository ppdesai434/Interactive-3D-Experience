...
public class ThreeDee extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	int newcount=0;
	static	int new2x = 0, new2y = 0, newx = 0, newy = 0 , xmean=0,ymean=0;
	...
	BranchGroup objRoot= new BranchGroup();
       ...
       t3d.setScale(0.02); // for jhonny
        t3d.setTranslation(new Vector3d(-1.4,-1.2,1.0)); 
	...
	try {
	 // s = f.load("src/app2obj.obj");
		//s= loader.load("src/un.wrl");
		s=loader.load("src/jhonny/jhonnny.wrl");
	//	s =loader.load("src/jhonny/jhonny2.wrl");
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  ThreeDee Mclaren = new ThreeDee(args);
	...
	public void onIrEvent(IREvent e) {
		...
		if (IRPoints.length == 2) {
			...
			new2x= IRPoints[1].getX();
			new2y= IRPoints[1].getY();
			xmean=(newx+new2x)/2;
			ymean=(newy+new2y)/2;
			xfactor=(double)(xmean-440)/760;
			yfactor=(double)(ymean-440)/760;
