...
public class Iron extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	BranchGroup objRoot= new BranchGroup();
      ...
      //  t3d.rotY(Math.toRadians(88.0));
       // t3d.rotZ(Math.toRadians(88.0));
        ...
        t3d.setScale(0.0004); //for carl house
	...
	try {
	 // s = f.load("src/app2obj.obj");
		s= loader.load("src/ironhouse/Google Earth Tony Stark' House Sketchup.wrl");
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  Iron objLoad = new Iron(args);
