 ...
 */
public class fourled extends javax.swing.JFrame implements WiimoteListener{
	double theta;
	public static int keyCode=0;
	static double m_old=0,m_new=0,x1=0,y1=0,x2=0,y2=0;
	static double x11,y11,x21,y21,x31,x41,y31,y41,x1avg,y1avg,x2avg,y2avg,m_new1,theta1,olddist1,newdist1,scalefac1,theta21;
	double scalefac;
	int count=0;
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  fourled objLoad = new fourled();
	...
	public void onIrEvent(IREvent e) {
		...
		/*	x31 = IRPoints[2].getX();
			...
			*/
			...
			newdist1= e.getDistance();
			if(olddist1-newdist1>2 || (olddist1-newdist1)<-2)
			{
				scalefac1=(newdist1*0.00625);	
			}
