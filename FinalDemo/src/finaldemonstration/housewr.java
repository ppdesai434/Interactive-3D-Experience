...
public class housewr extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	s=loader.load("src/housewrl/B&C 780 and 910.wrl");
	}
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  housewr Mclaren = new housewr(args);
