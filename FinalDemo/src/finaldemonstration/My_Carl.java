...
public class My_Carl extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	BranchGroup objRoot= new BranchGroup();
       ...
       /* t3d.rotY(Math.toRadians(-88.0));
         t3d.setScale(0.004);
        t3d.setScale(0.4);*/
       // t3d.rotX(Math.toRadians(-90.0)); jhonny
       // t3d.setScale(0.025); jhonny
       // t3d.setTranslation(new Vector3d(-2.2,-1.6,0.0));
     ...
     // t3d.rotZ(Math.toRadians(90.0));
      //t3d.rotX(Math.toRadians(-90.0)); 
       ...
       // t3d.setScale(0.004); //for carl house
       
       //t3d.setScale(0.02); // for untitled(2).wrl
     //  t3d.setTranslation(new Vector3d(-0.05,-0.07,0.0)); // for car
      //  t3d.setTranslation(new Vector3d(-1.0,-0.8,0.0)); // carl house
        t3d.setTranslation(new Vector3d(0.2,-0.5,0.0)); // carl house
        objScale.setTransform(t3d);
	...
	try {
	 // s = f.load("src/app2obj.obj");
		s= loader.load("src/carl/carl house.wrl");
		//s=loader.load("src/mclaren/McLaren.wrl");
	//	s= loader.load("src/untitled(2).wrl");
	}
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  My_Carl Mclaren = new My_Carl(args);
