...
public class Alto extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	BranchGroup objRoot= new BranchGroup();
     ...
     t3d.setScale(0.4); // for untitled(2).wrl
	...
	// our behavior code can modisefy it at runtime.  Add it to the
	...
	s=loader.load("src/alto/2011 Suzuki Alto (JDM).wrl");
	}
   ...
   //     java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            //public void run() {
              ...
              final  Alto Mclaren = new Alto(args);
