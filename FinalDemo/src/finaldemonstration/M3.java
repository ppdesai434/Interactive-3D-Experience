...
public class M3 extends javax.swing.JFrame implements WiimoteListener{
	double scalefac;
	double theta;
	...
	BranchGroup objRoot= new BranchGroup();
     ...
     // t3d.rotZ(Math.toRadians(90.0));
      t3d.rotX(Math.toRadians(-90.0)); 
       ...
       t3d.setScale(0.010); // for untitled(2).wrl
     //  t3d.setTranslation(new Vector3d(-0.05,-0.07,0.0)); // for car
        t3d.setTranslation(new Vector3d(-0.0,-0.0,0.0)); // carl house
        objScale.setTransform(t3d);
